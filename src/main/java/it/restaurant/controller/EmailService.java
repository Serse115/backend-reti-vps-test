...
public class EmailService {
    ...
    @Value("${app.mail.from:Progretiurb <ordiniRistorante@progretiurb.com>}")
    private String fromEmail;

    // Method to send the OTP email to the chosen email address
    ...
    // Send the final confirmation of the delivery order email
    public void sendOrderConfirmationEmail(String to, OrderRequestDTO request) {
        ...
        htmlBuilder.append("<p>Nominativo ordine: <strong>").append(request.getName()).append("</strong> </p>");
        htmlBuilder.append("<p>Indirizzo: <strong>").append(request.getAddress()).append("</strong> </p>");
        htmlBuilder.append("<p>Città: <strong>").append(request.getCity()).append("</strong> </p>");
        htmlBuilder.append("<p>CAP: <strong>").append(request.getCap()).append("</strong> </p>");
        htmlBuilder.append("<p>Telefono: <strong>").append(request.getPhone()).append("</strong> </p>");
        htmlBuilder.append("<p>Riepilogo dei piatti scelti:</p>");
        htmlBuilder.append("<ul>");

        for (OrderItemDTO item : request.getItems()) {
            htmlBuilder.append("<li>")
                    .append("Codice Piatto: <strong>").append(item.getMealCode()).append("</strong> ")
                    .append("- Nome piatto: <strong>").append(item.getMealName()).append("</strong> ")
                    .append("- Quantità: <strong>").append(item.getQuantity()).append("</strong>")
                    .append("</li>");
        }
        htmlBuilder.append("</ul>");
