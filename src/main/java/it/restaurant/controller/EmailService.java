...
public class EmailService {
    ...
    public void sendOtpEmail(String to, String otp) {
        ...
        CreateEmailOptions params = CreateEmailOptions.builder()
                ...
                .html("<strong>Il tuo codice di verifica è: " + otp + "</strong> <br>"
                        + "Usalo per confermare sulla pagina dell'ordine. <br>"
                        + "Se non sei stato tu a richiederlo, <strong>ignora</strong> questa email.")
                .build();
