    ...
    private void createTXTForData(String tableNum, String filePath, Object[][] data) {
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            try (FileWriter writer = new FileWriter(fileToSave)) {
                ...
                System.out.println("TXT correctly exported in " + fileToSave.getAbsolutePath());

            } catch (Exception e) {
                System.err.println("TXT not correctly exported: " + e.getMessage());
            }
        } else {
            System.err.println("Export canceled!");
        }
    }
}