...
public final class DBCreationOperations implements DBCreationOperationsInterface {
    ...
    private void createReservationTable(final String user, final String password) {
        ...
        try {                                                                          // This time it connects to the freshly-created DB,
            ...
            System.err.println("Could not create the reservations table in the DB!");
        }
    }
    ...
    private void createOrderTable() {
        ...
        try {
            ...
            System.err.println("Could not create the orders table in the DB!");
        }
    }
    ...
    private void createWaiterTable() {
        ...
        try {
            ...
            System.err.println("Could not create the waiter table in the DB!");
        }
    }
    ...
    private void createTableManagementTable() {
        ...
        try {
            ...
            System.err.println("Could not create the table management table in the DB!");
        }
    }
    ...
    private void createTrigger1() {
        ...
        try {
            ...
            System.err.println("Could not create the trigger 1 in the DB!");
        }
    }
    ...
    private void createTrigger2() {
        ...
        try {
            ...
            System.err.println("Could not create the trigger 2 in the DB!");
        }
    }
    ...
    private void populateWaiterTable() {
        ...
        try {
            ...
            System.err.println("Could not populate the waiter table in the DB!");
        }
    }
