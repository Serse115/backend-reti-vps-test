...
public final class DBCreationOperations implements DBCreationOperationsInterface {
    ...
    private void populateMenuTable() {
        ...
        final String sqlCommand = """
                ...
                VALUES ('ST01', 'Primi', 'Spaghetti al baioioiab', 12.99, 'spaghetti al saas', 255),\r
                 ('ST02', 'Antipasti', 'Involtini al siis', 10.99, 'involtini con carne di siis', 255),\r
                 ('FC01', 'Primi', 'Carbonara al carbone', 12.99, 'carbonara cotta al carbone', 255),\r
                 ('SC01', 'Secondi', 'Arrosto di soos', 15.99, 'carne di soos arrosto', 255),\r
                 ('DR01', 'Bevande', 'Acqua lezza', 1.99, 'acqua lezza direttamente dalle fonti sudicie', 255),\r
                 ('DE01', 'Dolci', 'Torta al leel', 9.99, 'torta al leel con zuuz', 255),\r
                 ('DE02', 'Dolci', 'Crema jamaicana', 11.99, 'crema jamaicana con paap', 255);""";
