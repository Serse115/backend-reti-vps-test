...
public class DBDeliveryOperations implements DBDeliveryOperationsInterface {
    ...
    public List<OrderRequestDTO> getTheDeliveryOrderCodesAndTheirInfo(int tag) {
        ...
        if (conn == null) {
            ...
            System.err.println(
                    "The DB is not connected for getTheDeliveryOrderCodesAndTheirInfo"
            );
            return ordersList;
        }
        ...
        final String sqlCommand =
                "SELECT * FROM delivery_order_details";
        ...
        try (PreparedStatement pstmt = conn.prepareStatement(sqlCommand);
            ...
            System.err.println(
                    "The Database is not connected or the data requested is not available!"
            );
