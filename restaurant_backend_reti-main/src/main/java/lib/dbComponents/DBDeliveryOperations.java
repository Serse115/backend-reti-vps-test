...
public class DBDeliveryOperations implements DBDeliveryOperationsInterface {
    ...
    public List<OrderRequestDTO> getTheDeliveryOrderCodesAndTheirInfo(int tag) {
        ...
        // Sql command for the method
        final String sqlCommand = "SELECT l.order_code, l.order_name, l.address, l.cap, l.city, l.email, l.phone " +
                "FROM delivery_orders_list l " +
                "INNER JOIN delivery_order_details d ON l.order_code = d.order_code;";
